...
export default function GitHubStatsSection() {
    ...
    return (
        <section id="github" className="section-dark mt-16 md:mt-24 py-[60px] md:py-[120px] px-8 sm:px-12 md:px-[8vw] lg:px-[10vw] xl:px-[12vw] 2xl:px-[14vw] border-t border-[#2a2a2a] overflow-hidden relative z-10">
            <div className="max-w-[1400px] w-full mx-auto">
                <SectionWrapper>
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-24">
                        <RevealText
                            text="OPEN SOURCE"
                            className="heading-section text-[2.5rem] sm:text-4xl md:text-5xl lg:text-6xl tracking-widest leading-[0.85] mb-6 md:mb-0"
                        />
                        <a
                ...
                <div className="grid md:grid-cols-12 gap-12">
                    ...
                    <div className="md:col-span-7 grid grid-cols-2 gap-8 md:gap-10 gap-y-16">
                        <SectionWrapper delay={0.2}>
                            <h3 className="font-mono text-xs sm:text-sm text-[#7a7a7a] mb-2 uppercase tracking-widest">Repositories</h3>
                            <div className="heading-display text-5xl sm:text-6xl md:text-8xl text-[#efece6]">
                                {loading ? <Loader2 className="animate-spin w-12 h-12 md:w-20 md:h-20 text-[#4a4a4a]" /> : data.repos}
                            </div>
                        </SectionWrapper>

                        <SectionWrapper delay={0.3}>
                            <h3 className="font-mono text-xs sm:text-sm text-[#7a7a7a] mb-2 uppercase tracking-widest">Total Stars</h3>
                            <div className="heading-display text-5xl sm:text-6xl md:text-8xl text-[#efece6]">
                        ...
                        <SectionWrapper delay={0.4}>
                            <h3 className="font-mono text-xs sm:text-sm text-[#7a7a7a] mb-2 uppercase tracking-widest">Followers</h3>
                            <div className="heading-display text-5xl sm:text-6xl md:text-8xl text-[#efece6]">
                        ...
                        <SectionWrapper delay={0.5}>
                            <h3 className="font-mono text-xs sm:text-sm text-[#7a7a7a] mb-2 uppercase tracking-widest">Forks Generated</h3>
                            <div className="heading-display text-5xl sm:text-6xl md:text-8xl text-[#efece6]">
