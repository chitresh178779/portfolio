            ...
            <div className="max-w-[1400px] w-full mx-auto flex-1 flex flex-col justify-center">
                ...
                {/* Massive Name Typography */}
                    <div className="flex flex-col mb-8">
                        <h1 className="heading-display text-[14vw] md:text-[10rem] lg:text-[13rem] whitespace-nowrap overflow-hidden">
                            <span className="hero-title block translate-y-full">
                                {firstName}
                            </span>
                        </h1>
                        <h1 className="heading-display text-[14vw] md:text-[10rem] lg:text-[13rem] leading-[0.8] whitespace-nowrap overflow-hidden -mt-2 md:-mt-6 lg:-mt-10 ml-auto">
                            <span className="hero-title block translate-y-full">
                                {lastName}
                            </span>
                        </h1>
