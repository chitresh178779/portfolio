        ...
        <section id="achievements" className="section-dark mt-16 md:mt-24 py-[60px] md:py-[120px] px-8 sm:px-12 md:px-[8vw] lg:px-[10vw] xl:px-[12vw] 2xl:px-[14vw] border-t border-[#2a2a2a] overflow-hidden relative z-10">
            <div className="max-w-[1400px] w-full mx-auto">
                <SectionWrapper>
                    <RevealText
                        text="MILESTONES"
                        className="heading-section text-[2.5rem] sm:text-4xl md:text-5xl lg:text-6xl tracking-widest mb-8 md:mb-12"
                    />
                </SectionWrapper>
                        ...
                        {achievements.map((item: any, index: number) => (
                            <SectionWrapper key={item.title} delay={0.1 * index}>
                                <div className="group border-b border-[#2a2a2a] pb-12 mb-8 md:mb-12 flex flex-col gap-4">
                                    <div className="flex md:items-center justify-between flex-col md:flex-row gap-2 md:gap-4">
                                        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-[#efece6] group-hover:text-[#8a8579] transition-colors">
                                            {item.title}
                                        </h3>
