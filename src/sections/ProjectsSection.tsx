...
export default function ProjectsSection() {
    return (
        <section id="projects" className="section-dark mt-16 md:mt-24 py-[60px] md:py-[120px] px-8 sm:px-12 md:px-[8vw] lg:px-[10vw] xl:px-[12vw] 2xl:px-[14vw] border-t border-[#2a2a2a] overflow-hidden relative z-10">
            <div className="max-w-[1400px] w-full mx-auto">
                <SectionWrapper>
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-32 md:mb-40">
                        <RevealText
                            text="PROJECTS"
                            className="heading-section text-[2.5rem] sm:text-5xl md:text-6xl lg:text-7xl tracking-widest leading-[1.25]"
                        />
